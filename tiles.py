...
class Tile:
    def __init__(self, p_pit=0):
        ...
        # place pit (or not!)
        self.states[state_index.PIT] = random.choices(
            [True, False], weights=(p_pit, 1 - p_pit), k=1)[0]

    def __str__(self):
        (p, w, g) = (self.states[state_index.PIT],
                     self.states[state_index.WUMPUS], self.states[state_index.GOLD])
